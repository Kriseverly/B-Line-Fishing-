  ...
  return (
    <main className="subpage">
      <nav className="subnav shell">
        ...
        <div><Link href="/">Home</Link><Link href="/#trips">Fishing</Link><Link href="/spearfishing">Spearfishing</Link><Link href="/conditions">Reports</Link><Link href="/info">FAQ</Link><Link href="/about">About</Link><Link href="/#book">Book a Trip</Link></div>
      </nav>
