...
export default function ConditionsPage() {
  return <main className="subpage">
    <nav className="subnav shell"><Link className="brand" href="/"><span>B-LINE<br/><b>FISHING CHARTERS</b></span></Link><div><Link href="/">Home</Link><Link href="/about">About</Link><Link href="/#book">Book a Trip</Link></div></nav>
