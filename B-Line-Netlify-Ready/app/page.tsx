...
import { ServicesJsonLd, FaqJsonLd, FAQS } from "./seo-data";
...
export default function Home() {
  return (
    <main>
      ...
      <section className="spearfishing" id="spearfishing">
        <div className="spearfishing-inner shell">
          <div className="spear-heading">
            <p className="eyebrow">BELOW THE SURFACE</p>
            <h2>PRIVATE<br/><em>SPEARFISHING</em><br/>EXPEDITIONS.</h2>
            <p>Family-friendly spearfishing adventures for beginners, families, and experienced freedivers. Every trip is planned around your group’s comfort and ability, with the day shaped by visibility, current, season, and conditions.</p>
            <BookingChoice className="button primary" value="Spearfishing expedition — custom quote">Plan a Dive Trip <span>→</span></BookingChoice>
          </div>
          <div className="spear-options">
            <BookingChoice className="spear-choice" value="Kelp & Reef spearfishing — custom quote"><article><span>01</span><div><h3>Kelp & Reef</h3><p>Island structure, kelp edges, and rocky reef for yellowtail, calico bass, sheephead, and seasonal opportunities.</p></div><b>SELECT →</b></article></BookingChoice>
            <BookingChoice className="spear-choice" value="Bluewater spearfishing — custom quote"><article><span>02</span><div><h3>Bluewater</h3><p>Open-water hunting around banks and temperature breaks when pelagic fish and conditions line up.</p></div><b>SELECT →</b></article></BookingChoice>
            <BookingChoice className="spear-choice" value="Custom Support spearfishing — custom quote"><article><span>03</span><div><h3>Custom Support</h3><p>Private route planning, safe drop-and-pickup positioning, and flexible locations for your experienced dive group.</p></div><b>SELECT →</b></article></BookingChoice>
            <div className="spear-note"><strong>Custom quote</strong><p>Route, hours, and group size determine pricing. Divers bring personal gear and must hold all required licenses. Trips are subject to weather, visibility, regulations, and operator approval.</p></div>
          </div>
        </div>
      </section>
